...
class StarDistBase(BaseModel):
    ...
    def __init__(self, config, name=None, basedir='.'):
        ...
        threshs = dict(prob=None, nms=None, affinity_thresh=None)
        if basedir is not None:
            try:
                ...
                if threshs.get('nms') is None or not (0 < threshs.get('nms') < 1):
                    ...
                    threshs['nms'] = None
                if threshs.get('affinity_thresh') is None or not (0 < threshs.get('affinity_thresh') < 1):
                    print("- Invalid 'affinity_thresh' threshold (%s), using default value." % str(threshs.get('affinity_thresh')))
                    threshs['affinity_thresh'] = None
        ...
        self.thresholds = dict (
            ...
            affinity_thresh  = 0.1 if threshs['affinity_thresh']  is None else threshs['affinity_thresh'],
        )
        print("Using default values: prob_thresh={prob:g}, nms_thresh={nms:g}, affinity_thresh={affinity_thresh:g}.".format(prob=self.thresholds.prob, nms=self.thresholds.nms, affinity_thresh=self.thresholds.affinity_thresh))
    ...
    def predict_instances(self, img, axes=None, normalizer=None,
                          ...
                          affinity=False, affinity_thresh=None,                                               verbose = False, affinity_kwargs=None, 
