...
class StarDistBase(BaseModel):
    ...
    def predict_instances(self, img, axes=None, normalizer=None,
        ...
        return self._instances_from_prediction(_shape_inst, prob, dist, prob_thresh=prob_thresh, nms_thresh=nms_thresh, affinity=affinity, affinity_thresh=affinity_thresh, affinity_kwargs = affinity_kwargs, overlap_label = overlap_label, **nms_kwargs)
